...
bool Foam::functionObjects::Qdot::calc()
{
    const tmp<volScalarField> tQdot
    (
        new volScalarField
        (
            IOobject
    ...
    return store(resultName_, tQdot, true);
}
...
:
    ...
    resultName_(dict.lookupOrDefault<word>("result", "Qdot"))
{
    calc();
}
...
bool Foam::functionObjects::Qdot::clear()
{
